...
Algoritmo sin_titulo
	...
	para i = 0 hasta n - 1
		para j = 0 hasta n - 1
			...
			si i = j Entonces
				diag1 = diag1 + matriz(i,j)     // SI LE AGREGAMOS UN SINO QUE INDIQUE QUE NO SUMA 15, SE TERMINA EL PROGR..
			FinSi
			
				si i + j = n - 1 Entonces
					diag2 = diag2 + matriz(i,j)  // SI LE AGREGAMOS UN SINO QUE INDIQUE QUE NO SUMA 15, SE TERMINA EL PROGR..
				FinSi
